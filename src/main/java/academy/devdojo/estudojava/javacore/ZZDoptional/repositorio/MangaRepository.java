package academy.devdojo.estudojava.javacore.ZZDoptional.repositorio;

import academy.devdojo.estudojava.javacore.ZZDoptional.dominio.Manga;
...
//    private static Optional<Manga> findoById(String id){
//        Manga found = null;
