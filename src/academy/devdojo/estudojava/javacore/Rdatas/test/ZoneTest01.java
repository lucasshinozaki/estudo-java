...
public class ZoneTest01 {
    public static void main(String[] args) {
        ...
        System.out.println(nowInstant); //Zulu-Time
        ...
        OffsetDateTime offsetDateTime4 = nowInstant.atOffset(offsetManaus);
        System.out.println(offsetDateTime4);

        JapaneseDate japanesDate = JapaneseDate.from(LocalDate.now());
        System.out.println(japanesDate);
