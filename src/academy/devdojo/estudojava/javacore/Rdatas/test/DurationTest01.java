...
public class DurationTest01 {
    public static void main(String[] args) {
        //USA A ISO 8601, não tem suporte para LocalDate por ela não usar seconds
        ...
        Duration d6 = Duration.of(3, ChronoUnit.HOURS); //alguns chronoUnit não tem suporte para seconds
